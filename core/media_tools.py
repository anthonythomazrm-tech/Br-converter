...
def find_ffmpeg() -> str:
    """
    Procura o ffmpeg em locais comuns do projeto e depois no PATH.
    """
    possible_paths = [
        _resource_path("bin/ffmpeg/ffmpeg.exe"),
    ]
    ...
    raise RuntimeError(
        ...
        "Coloque o ffmpeg.exe em uma dessas pastas ou instale o FFmpeg e adicione ao PATH."
    )
...
def audio_to_video_cover(audio_path: str, image_path: str, out_video_path: str):
    """Cria vídeo MP4 com imagem fixa + áudio."""
    ffmpeg = find_ffmpeg()
